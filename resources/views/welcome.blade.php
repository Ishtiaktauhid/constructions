...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/tiny-slider.css')}}" />
  ...
  <body>
      ...
      <div class="container">
        <div class="menu-bg-wrap">
          <div class="site-navigation">
            <a href="index.html" class="logo m-0 float-start">Real State</a>
    ...
    <div class="hero">
      <div class="hero-slide">
        <div
          class="img overlay"
          style="background-image: url('{{asset('public/frontend/images/hero_bg_3.jpg')}}')"
        ></div>
        <div
          class="img overlay"
          style="background-image:url('{{asset('public/frontend/images/hero_bg_2.jpg')}}')"
        ></div>
        <div
          class="img overlay"
          style="background-image: url('{{asset('public/frontend/images/hero_bg_1.jpg')}}')"
        ></div>
      </div>
          ...
          <div class="col-12">
            <div class="property-slider-wrap">
              <div class="property-slider">
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="{{asset('public/frontend/images/img_7.jpg')}}" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="{{asset('public/frontend/images/img_8.jpg')}}" alt="Image" class="img-fluid" />
                  </a>
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{asset('public/frontend/images/person_1-min.jpg')}}"
                  alt="Image"
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{asset('public/frontend/images/person_2-min.jpg')}}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{asset('public/frontend/images/person_3-min.jpg')}}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{asset('public/frontend/images/person_4-min.jpg')}}"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <div class="rate">
        ...
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
            <div class="img-about dots">
              <img src="{{asset('public/frontend/images/hero_bg_3.jpg')}}" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
