...
<head>
  ...
  <link rel="icon" type="image/png" href="{{asset('public/assetss/img/favicon.png')}}">
  <title>
    CMS Projects
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="{{asset('public/assetss/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <script src="{{asset('public/assetss/js/material-dashboard.min.js?v=3.1.0')}}"></script>
</body>
