    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('material.store')}}">
                        @csrf
                        ...
                        <div class="row">
                           <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="material_name" class="form-control" value="{{ old('material_name')}}" name="material_name">
