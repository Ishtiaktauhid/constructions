    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('property.update',$pimage->id)}}">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="project_id" id="project_id">
                                        ...
                                        @forelse($project as $p)
                                            <option value="{{$p->id}}" {{ old('project_id', $pimage->project_id)==$p->id?"selected":""}}> {{$p->project_name}}</option>
                                        @empty
