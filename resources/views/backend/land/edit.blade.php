    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('land.update',encryptor('encrypt',$land->id))}}">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                           <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="userName_en" class="form-control" value="{{ old('name_en',$land->name_en)}}" name="name_en">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name_bn" class="form-control" value="{{ old('name_bn',$land->name_bn)}}" name="name_bn">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="description" class="form-control" value="{{ old('description',$land->description)}}" name="description">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mouza_no_en" class="form-control" value="{{ old('mouza_no_en',$land->mouza_no_en)}}" name="mouza_no_en">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mouza_no_bn" class="form-control" value="{{ old('mouza_no_bn',$land->mouza_no_bn)}}" name="mouza_no_bn">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rs_no_en" class="form-control" value="{{ old('rs_no_en',$land->rs_no_en)}}" name="rs_no_en">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rs_no_bn" class="form-control" value="{{ old('rs_no_bn',$land->rs_no_bn)}}" name="rs_no_bn">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bs_no_en" class="form-control" value="{{ old('bs_no_en',$land->bs_no_en)}}" name="bs_no_en">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="bs_no_bn" class="form-control" value="{{ old('bs_no_bn',$land->bs_no_bn)}}" name="bs_no_bn">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="registration_no_en" class="form-control" value="{{ old('registration_no_en',$land->registration_no_en)}}" name="registration_no_en">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="registration_no_bn" class="form-control" value="{{ old('registration_no_bn',$land->registration_no_bn)}}" name="registration_no_bn">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="land_area" class="form-control" value="{{ old('land_area',$land->land_area)}}" name="land_area">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="acquire_date" class="form-control" value="{{ old('acquire_date',$land->acquire_date)}}" name="acquire_date">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="original_owner_details" class="form-control" value="{{ old('original_owner_details',$land->original_owner_details)}}" name="original_owner_details">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="price" class="form-control" value="{{ old('price',$land->price)}}" name="price">
                                    @if($errors->has('price'))
