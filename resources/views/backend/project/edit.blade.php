    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('project.update',$project->id)}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="project_name" class="form-control" value="{{ old('project_name',$project->project_name)}}" name="project_name">
                          ...
                          <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="description" class="form-control" value="{{ old('description',$project->description)}}" name="description">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="start_time" class="form-control" value="{{ old('start_time',$project->start_time)}}" name="start_time">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="start_time" class="form-control" value="{{ old('end_time',$project->end_time)}}" name="end_time">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="other_project_details" class="form-control" value="{{ old('other_project_details',$project->other_project_details)}}" name="other_project_details">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="project_value" class="form-control" value="{{ old('project_value',$project->project_value)}}" name="project_value">
